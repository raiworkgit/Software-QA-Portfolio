...
### Description:
In the Maintenance & Support module under the Current Sprint view, the system does not display any tickets even when valid sprint data is expected to be available. This affects visibility of active sp[...]
